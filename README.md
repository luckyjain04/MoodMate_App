...
Analyzes user input text to classify emotions such as happy, sad, angry, stressed, or neutral.

💬 Interactive Chatbot
Provides real-time conversational support with empathetic responses.

📊 Mood Tracking
Stores mood history for self-reflection and emotional awareness.

🎯 Personalized Suggestions
Recommends relaxation techniques, motivational messages, or activities based on detected mood.
...
Frontend	Tkinter / Flask (if web-based)
Backend	Python
